...
def main_worker(args):
    ...
    if os.path.isfile(pretrain):
            ...
            model = SalsaSeg(pretrain)
    else:
        print(f"\033[CHECK THE PRETRAIN MODEL PATH !!!]\033[0m")
        return
    ...
    train_dataset = parserModule.KittiRV('train', ARCH, DATA, args.data,
                                        gt=True,transform=False,drop_few_static_frames=True)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if epoch % 3 == 0:
            ...
            }, is_best=False, filename='seg_checkpoint_{:04d}.pth.tar'.format(epoch))
