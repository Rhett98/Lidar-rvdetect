...
from modules.DualSalsaNext import *
...
class Trainer():
    def __init__(self, ARCH, DATA, datadir, logdir, path=None,uncertainty=False):
        ...
        self.parser = parserModule.KittiRV('train', ARCH, DATA, datadir, True)
        ...
        with torch.no_grad():
            if not self.uncertainty:
                self.model = DualSalsaNext(self.parser.get_n_classes(), self.ARCH)
            else:
